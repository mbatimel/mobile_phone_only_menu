...
func (srv *Server) WithLog() *Server {
	if srv.httpPublicApi != nil {
		srv.httpPublicApi = srv.PublicApi().WithLog()
	}
	return srv
}
...
func (srv *Server) WithMetrics() *Server {
	...
	if srv.httpPublicApi != nil {
		srv.httpPublicApi = srv.PublicApi().WithMetrics()
	}
	return srv
}

func (srv *Server) PublicApi() *httpPublicApi {
	return srv.httpPublicApi
}
